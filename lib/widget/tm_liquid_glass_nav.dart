...
/// Jelly transform matrix for organic squash and stretch on drag
...
class TmLiquidGlassBottomBar extends StatefulWidget {
  const TmLiquidGlassBottomBar({
    super.key,
    required this.tabs,
  ...
  final List<TmLiquidGlassTab> tabs;
  final int selectedIndex;
  final ValueChanged<int> onTabSelected;
  final TmLiquidGlassExtraButton? extraButton;
  ...
  @override
  State<TmLiquidGlassBottomBar> createState() =>
      _TmLiquidGlassBottomBarState();
}

class _TmLiquidGlassBottomBarState extends State<TmLiquidGlassBottomBar> {
  @override
...
class TmLiquidGlassTab {
  const TmLiquidGlassTab({
    required this.label,
    required this.icon,
    this.selectedIcon,
    this.glowColor,
...
class TmLiquidGlassExtraButton {
  const TmLiquidGlassExtraButton({
    required this.icon,
    required this.onTap,
    required this.label,
    this.size = 64,
...
// ═══════════════════════════════════════════════
// TAB INDICATOR (slider draggabile)
// ═══════════════════════════════════════════════
